...
public class SupplierController {
    ...
    Pattern idPattern = Pattern.compile("^(S)[0-9]{1,3}$");
    Pattern namePattern = Pattern.compile("^[A-z ]{3,40}$");
    Pattern contactPattern = Pattern.compile("^(071|072|073|074|070|075|076|077|078|079)[-]?[0-9]{6}$");
    ...
    public void btnPrint(ActionEvent actionEvent) {
        new Thread() {
            ...
            public void run() {
                try {
                    JasperDesign load = JRXmlLoader.load(new File("C:\\CLOTHS_SHOP_MANAGEMENT_SYSTEM\\src\\main\\java\\invoice\\Supplier_all_form.jrxml"));
